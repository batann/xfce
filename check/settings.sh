...
readonly DEFAULT_OPTIONS=("Set Timezone" "Set Power Manager" "Set window Snapping" "Set Key Binding" "Set Firewall Rules" "Setup Cloud Storage" "Set Usr Visudo" "Gen GPG" "Gen SSH-key" "Install Sys Fonts" "Custom Themes" "Bind Caps Esc Ctrl" "Setup SuperKey" "Conf LAMP" "Fstab DATA" "Update Grub" "Customize Grub" ">>> MAINMENU <<<")
...
confirm() {
    if $will_return_index; then
		...
		0) sudo -u batan bash /home/batan/check/timezone.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		1) sudo -u batan bash /home/batan/check/powermanager.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		2) sudo -u batan bash /home/batan/check/snapwindow.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		3) sudo -u batan bash /home/batan/check/keybinding.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		4) sudo -u batan bash /home/batan/check/firewall.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		5) sudo -u batan bash /home/batan/check/mega.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		6) sudo -u batan bash /home/batan/check/visudo.sh && sudo -u batan bash /home/batan/check/settings.sh ;; 
		7) sudo -u batan bash /home/batan/check/gpg.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		8) sudo -u batan bash /home/batan/check/ssh.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		9) sudo -u batan bash /home/batan/check/fonts.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		10) sudo -u batan bash /home/batan/check/themes.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		11) sudo -u batan bash /home/batan/check/caps.sh && sudo -u batan bash /home/batan/check/settings.sh ;; 
		12) sudo -u batan bash /home/batan/check/superkey.sh && sudo -u batan bash /home/batan/check/settings.sh ;; 
		13) sudo -u batan bash lamp.t.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		14) sudo -u batan bash /home/batan/check/fstab.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
		15) sudo update-grub && sudo -u batan bash /home/batan/check/settings.sh ;;
		16) /usr/bin/xterm -fa 'Terminus' -fs 9 -geom 50x30+0+0 -e bash -c "sudo bash /home/batan/check/custom-grub.sh" && sudo -u batan bash /home/batan/check/settings.sh ;;

		17) sudo -u batan bash /home/batan/check/first.sh && sudo -u batan bash /home/batan/check/settings.sh ;;
