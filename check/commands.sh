...
readonly DEFAULT_OPTIONS=("Update" "Clean" "Shred" "Nuke" "Update-grub" "SSH to Loacal" "SCP from Local" "Get from Cloud" "XXXXX" "USB2F32" "XXX" "XX" "XXXX" "Cloud Content" ">>> Srt_Rigt " ">>> Down MP4" ">>> Down MP3" ">>> Countdown" ">>> POPUP" ">>> MAT2 " "Wipe Partition" "Kill PID" "SSH CONNECT" "MEGA content" "SNAPandUSER" "Optimaze Images" ">>> MAINMENU <<<")
...
confirm() {
    if $will_return_index; then
		...
		0) sudo apt update && sudo apt upgrade && sudo -u batan bash commands.sh ;;
		1) xterm -geom 50x40+0-0 -e 'sudo -u batan bash clean.sh' &&  sudo -u batan bash commands.sh ;;
		2) xterm -geom 50x40+0-0 -e 'sudo -u batan bash shred.sh' &&  sudo -u batan bash commands.sh ;;
		3) xterm -geom 50x40+0-0 -e 'sudo -u batan bash nuke.sh' && sudo -u batan bash commands.sh ;;
		4) xterm -geom 50x40+0-0 -e bash -c 'sudo update-grub && clear && read -n1 -p 'Press any to Continue...' xxx' ;;
		5) xterm  -geom 50x30+0+0 -e bash -c 'sudo -u batan bash setssh.sh' && sudo -u batan bash commands.sh ;;
6) xterm -geom 50x40+0-0 -e bash -c "sudo -u batan bash scplocal.sh && sudo -u batan bash commands.sh" ;;
7) xterm -geom 50x40+0-0 -e bash -c "sudo -u batan bash mega.sh && sudo -u batan bash commands.sh" ;;
8) xterm -geom 50x40+0-0 -e bash -c "sudo -u batan bash fstab.sh && sudo -u batan bash commands.sh" ;;
9) xterm -geom 50x40+0-0 -e bash -c 'sudo -u batan bash usb.sh' ;;
10) xterm -geom 50x40+0-0 -e bash -c 'sudo -u batan bash  && sudo -u batan bash commands.sh' ;;
11) xterm -geom 50x40+0-0 -e bash -c 'sudo -u batan bash  && sudo -u batan bash commands.sh' ;;
12) xterm -geom 50x40+0-0 -e bash -c 'sudo -u batan bash  && sudo -u batan bash commands.sh' ;;
13) xterm -geom 50x40-300-0 -e "sudo -u batan bash /home/batan/check/megals.sh && sudo -u batan bash commands.sh" ;;
14) sudo -u batan bash start_right.sh && sudo -u batan bash commands.sh ;;
15) xfce4-terminal --geometry=100x10+100+100 --hide-borders --hide-menubar --hide-scrollbar --zoom=-1 -e "sudo -u batan bash /home/batan/check/downv.sh" && sudo -u batan bash commands.sh ;;
16)  xfce4-terminal --geometry=100x10+100+100 --hide-borders --hide-menubar --hide-scrollbar --zoom=-1 -e "sudo -u batan bash /home/batan/check/downm.sh" && sudo -u batan bash commands.sh ;;
17) xterm -geom 50x8+0+0 -e bash -c 'sudo -u batan bash /home/batan/check/count1.sh && sudo -u batan bash commands.sh' ;;
18) xterm -geom 50x10+0+0 -e bash -c 'sudo -u batan bash /home/batan/check/popup.sh' ;;
19) xterm -geom 50x10+0+0 -e bash -c 'sudo -u batan bash /home/batan/check/metadata.sh' ;;
20) xterm -geom 60x30-0-0 -e bash -c "read -p 'partition, please /dev/sd??  >>>' xfg && nwipe /dev/sd$xfg" && sudo -u batan bash /home/batan/check/commands.sh ;;
21) xterm -geom 60x30-0-0 -fs 9 -e bash -c "sudo -u batan bash /home/batan/check/psaux.sh" && sudo -u batan bash /homee/batan/check/commands.sh ;;
22) sudo -u batan bash /home/batan/check/sssh.sh && sudo -u batan bash /homee/batan/check/commands.sh ;;
23) sudo -u batan bash /home/batan/check/megastorage.sh && sudo -u batan bash /home/batan/check/commands.sh;;
24) xterm -geom 100x20-0-0 -hold -e bash -c "sudo -u batan bash /home/batan/check/snapshot.sh" && sudo -u batan bash /home/batan/check/commands.sh;;
25) xterm -geom 100x20-0-0 -hold -e bash -c "sudo -u batan bash /home/batan/check/image_optim.sh" && sudo -u batan bash /home/batan/check/commands.sh;;
26) sudo -u batan bash first.sh ;;
