...
readonly DEFAULT_OPTIONS=("vimwiki" "vim-taskwarrior" "taskwiki" "tabular" "calendar-vim" "tagbar" "vim-plugin-AnsiEsc" "vim-table-mode" "deoplete.nvim " "emmet-vim" "ale " "html.vim " "vim-surround" "vim-lsp" "vim-lsp-ale" "prettier " "unite.vim" "awesome-vim-colorschemes" ">>>INSTALL SOFTWARE<<<" ">>>MAIN MENU<<<")
...
confirm() {
	...
	;;
		...
		4)
				 git clone https://github.com/itchyny/calendar.vim.git /home/batan/.vim/pack/plugins/start/calendar-vim &&
			sudo -u batan bash vim.sh
				 ;;
